        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="bg-white p-4 rounded mb-4">
                    <h5>Call Us</h5>
                    <a href="tel : +212621820624" class="d-inline-block mb-2 text-decoration-none text-dark"><i
                    ...
                    <span class="badge text-dark fs-6 p-2">
                        <a href="https://www.instagram.com/houseofvintagehouseofart?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                            class="d-inline-block mb-2 text-decoration-none text-dark"><i
                                class="bi bi-instagram me-1"></i></i>Instagram</a>
                    </span><br>
                    <span class="badge text-dark fs-6 p-2">
                        <a href="https://www.instagram.com/houseofvintagehouseofart?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                            class="d-inline-block mb-2 text-decoration-none text-dark"><i class="bi bi-facebook"></i>
                            Facebook</a>
                    </span>
                </div>
            </div>
